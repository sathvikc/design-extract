...
const FEATURED = {
  ...
  // ── v13 expansion — pre-rendered brand books under public/gallery/<slug>/ ──
  'raycast-com':     { host: 'raycast.com'     },
  'supabase-com':    { host: 'supabase.com'    },
  'framer-com':      { host: 'framer.com'      },
  'resend-com':      { host: 'resend.com'      },
  'clerk-com':       { host: 'clerk.com'       },
  'cal-com':         { host: 'cal.com'         },
  'discord-com':     { host: 'discord.com'     },
  'netflix-com':     { host: 'netflix.com'     },
  'duolingo-com':    { host: 'duolingo.com'    },
  'coinbase-com':    { host: 'coinbase.com'    },
  'loom-com':        { host: 'loom.com'        },
  'webflow-com':     { host: 'webflow.com'     },
  'postman-com':     { host: 'postman.com'     },
  'replit-com':      { host: 'replit.com'      },
  'railway-app':     { host: 'railway.app'     },
  'render-com':      { host: 'render.com'      },
  'mintlify-com':    { host: 'mintlify.com'    },
  'posthog-com':     { host: 'posthog.com'     },
  'sentry-io':       { host: 'sentry.io'       },
  'perplexity-ai':   { host: 'perplexity.ai'   },
  'ramp-com':        { host: 'ramp.com'        },
  'retool-com':      { host: 'retool.com'      },
  'planetscale-com': { host: 'planetscale.com' },
  'v0-dev':          { host: 'v0.dev'          },
};
