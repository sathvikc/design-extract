# You are building UI in the render.com design system.
...
- secondary   #e7dbff
- accent      #e0f4ff
- neutrals    #e3e3e3 · #0d0d0d · #ffffff · #000000 · #6b6b6b · #4d4d4d

## Typography

- families   PPNeueMontreal · Roobert · Helvetica · PPNeueMontrealMono
- weights    400 · 500 · 300
- base size  16px

## Spacing

- scale      1px · 48px · 56px · 72px · 80px · 86px · 120px · 160px · 166px · 201px · 213px · 270px

## Radii

- scale      2px · 50px · 937px
...
- CTA verbs  start · view · trust · hipaa · deploy · fermer
...
Generated by designlang. Re-extract by running `npx designlang render.com`.
