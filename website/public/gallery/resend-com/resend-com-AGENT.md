# You are building UI in the resend.com design system.
...
- secondary   #00a3ff
- accent      #44ffa4
- neutrals    #f0f0f0 · #a1a4a5 · #ffffff · #f1f7fe · #464a4d · #6c6c6c

## Typography

- families   inter · commitMono · aBCFavorit · Helvetica
- weights    400 · 500 · 600 · 700
- base size  16px

## Spacing

- scale      1px · 20px · 24px · 28px · 40px · 48px · 62px · 80px · 96px · 104px · 144px · 150px
...
- CTA verbs  get · node · user · features · company · resources
...
Generated by designlang. Re-extract by running `npx designlang resend.com`.
